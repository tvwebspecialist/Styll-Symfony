...
> ℹ️ Questo è il riassunto del progetto. Per i dettagli completi, consulta la documentazione in [`docs/`](../README.md).
...
> Per l'indice completo di tutta la documentazione del progetto, consulta [`docs/README.md`](../README.md).