...
> **Fonti originali:** `progetto/08-roadmap-e-sviluppo.md`
...
## Indice tesi (definitivo — 8 capitoli, struttura ABA)

> ℹ️ Indice definitivo deciso durante la sessione di audit dell'8 aprile 2026. Le versioni precedenti (10 capitoli progettuali, 6 capitoli academic) sono obsolete.
...
### Capitolo 6 — Progettazione UX/UI (25-35 pp.)
...
> Per l'indice completo con tutte le sezioni vedere: [`docs/09-tesi/indice-tesi.md`](../09-tesi/indice-tesi.md)