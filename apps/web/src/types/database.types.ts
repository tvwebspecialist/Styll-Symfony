  ...
  public: {
    Tables: {
      ...
      appointment_products: {
        ...
        Relationships: [
          {
            foreignKeyName: "appointment_products_applied_promotion_id_fkey"
      ...
      appointment_services: {
        ...
        Relationships: [
          {
            foreignKeyName: "appointment_services_applied_promotion_id_fkey"
            columns: ["applied_promotion_id"]
            isOneToOne: false
            referencedRelation: "promotions"
            referencedColumns: ["id"]
      ...
      client_import_jobs: {
        ...
        Relationships: [
          {
            foreignKeyName: "client_import_jobs_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      client_product_wishlist: {
        ...
        Relationships: [
          {
            foreignKeyName: "client_product_wishlist_client_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "client_product_wishlist_product_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "client_product_wishlist_tenant_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      notification_log: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "notification_log_promotion_id_fkey"
      ...
      promotion_services: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "promotion_services_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
