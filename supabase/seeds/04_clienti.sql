...
VALUES
  ('j1000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000004',
   'Luca Martini', '+39 347 2000001', 'luca.martini@email.it', '1990-05-15', '["vip","loyal"]', true, 'whatsapp'),
  ('j1000000-0000-0000-0000-000000000002', 'b1000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000005',
   'Sara Conti', '+39 347 2000002', 'sara.conti@email.it', '1995-08-22', '["churn-risk"]', true, 'whatsapp'),
  ...
  ('j1000000-0000-0000-0000-000000000004', 'b1000000-0000-0000-0000-000000000001', NULL,
   'Marco Ferraro', '+39 347 2000004', 'marco.ferraro@email.it', '1988-11-01', '["active"]', true, 'whatsapp'),
  ('j1000000-0000-0000-0000-000000000005', 'b1000000-0000-0000-0000-000000000001', NULL,
   'Giulia Romano', '+39 347 2000005', 'giulia.romano@email.it', '1993-04-17', '["active"]', true, 'whatsapp'),
  ...
  ('j1000000-0000-0000-0000-000000000007', 'b1000000-0000-0000-0000-000000000001', NULL,
   'Francesca Marino', '+39 347 2000007', 'francesca.marino@email.it', '1997-02-14', '["active"]', true, 'whatsapp'),
  ('j1000000-0000-0000-0000-000000000008', 'b1000000-0000-0000-0000-000000000001', NULL,
   'Davide Costa', '+39 347 2000008', 'davide.costa@email.it', '1985-09-05', '["vip"]', true, 'whatsapp'),
  ('j1000000-0000-0000-0000-000000000009', 'b1000000-0000-0000-0000-000000000001', NULL,
   'Elena Bruno', '+39 347 2000009', 'elena.bruno@email.it', '1992-12-20', '["active"]', true, 'whatsapp'),
  ('j1000000-0000-0000-0000-000000000010', 'b1000000-0000-0000-0000-000000000001', NULL,
   'Matteo Ricci', '+39 347 2000010', 'matteo.ricci@email.it', '1987-06-08', '["active"]', true, 'whatsapp'),
  ('j1000000-0000-0000-0000-000000000011', 'b1000000-0000-0000-0000-000000000001', NULL,
   'Valentina Greco', '+39 347 2000011', 'valentina.greco@email.it', '1999-01-25', '["new"]', true, 'whatsapp'),
  ('j1000000-0000-0000-0000-000000000012', 'b1000000-0000-0000-0000-000000000001', NULL,
   'Alessandro Ferrari', '+39 347 2000012', 'alex.ferrari@email.it', '1991-10-12', '["active"]', true, 'whatsapp'),
  ('j1000000-0000-0000-0000-000000000013', 'b1000000-0000-0000-0000-000000000001', NULL,
   'Chiara Bianchi', '+39 347 2000013', 'chiara.bianchi@email.it', '1996-03-30', '["new"]', true, 'whatsapp'),
  ...
  ('j1000000-0000-0000-0000-000000000016', 'b1000000-0000-0000-0000-000000000001', NULL,
   'Diego Barbieri', '+39 347 2000016', 'diego.barbieri@email.it', '1998-05-02', '["new"]', true, 'whatsapp'),
  ...
  ('j1000000-0000-0000-0000-000000000018', 'b1000000-0000-0000-0000-000000000001', NULL,
   'Riccardo Gallo', '+39 347 2000018', 'riccardo.gallo@email.it', '1993-07-21', '["new"]', true, 'whatsapp'),
  ('j1000000-0000-0000-0000-000000000019', 'b1000000-0000-0000-0000-000000000001', NULL,
   'Serena Caruso', '+39 347 2000019', 'serena.caruso@email.it', '1989-02-28', '["vip"]', true, 'whatsapp'),
  ('j1000000-0000-0000-0000-000000000020', 'b1000000-0000-0000-0000-000000000001', NULL,
   'Paolo Santoro', '+39 347 2000020', 'paolo.santoro@email.it', '2000-04-01', '["new"]', true, 'whatsapp')
ON CONFLICT (id) DO NOTHING;
